...
export class AdminCouponsController {
  ...
  @Get()
  findAll(
    @Query(new ZodValidationPipe(QueryCouponsSchema)) query: QueryCouponsQuery,
  ) {
  ...
  @Post()
  create(
    @Body(new ZodValidationPipe(CreateCouponSchema)) dto: CreateCouponBody,
  ...
  @Post('batch')
  generateBatch(
    @Body(new ZodValidationPipe(CreateCouponBatchSchema))
    dto: CreateCouponBatchBody,
    @CurrentUser() user: IAuthUser,
  ) {
