...
import { QueryExpertsSchema, type QueryExpertsQuery } from './dto/query-experts.dto.js';
import { UpdateExpertSchema, type UpdateExpertBody } from './dto/update-expert.dto.js';
...
export class AdminExpertsController {
  ...
  @Get()
  findAll(@Query(new ZodValidationPipe(QueryExpertsSchema)) query: QueryExpertsQuery) {
  ...
  @Patch(':id')
  update(@Param('id', ParseIntPipe) id: number, @Body(new ZodValidationPipe(UpdateExpertSchema)) dto: UpdateExpertBody) {
