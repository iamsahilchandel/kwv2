...
import { CreateCenterInquiryDto } from './dto/create-center-inquiry.dto.js';
import { UpdateCenterInquiryDto } from './dto/update-center-inquiry.dto.js';
import { QueryCenterInquiriesDto } from './dto/query-center-inquiries.dto.js';
import { CenterInquiryNoteDto } from './dto/center-inquiry-note.dto.js';
...
export class AdminCenterInquiriesController {
  ...
  @Post()
  create(@Body() dto: CreateCenterInquiryDto, @CurrentUser() user: IAuthUser) {
    return this.service.create(dto, user);
  }

  @Get()
  findAll(@Query() query: QueryCenterInquiriesDto) {
  ...
  update(
    ...
    @Body() dto: UpdateCenterInquiryDto,
