...
import { GovPicklistQuerySchema, type GovPicklistQuery } from './dto/gov-picklist.dto.js';
...
export class GovPicklistController {
  ...
  @Public()
  @Get('states')
  async getStates(@Query(new ZodValidationPipe(GovPicklistQuerySchema)) query: GovPicklistQuery) {
  ...
  @Public()
  @Get('districts')
  async getDistricts(@Query(new ZodValidationPipe(GovPicklistQuerySchema)) query: GovPicklistQuery) {
